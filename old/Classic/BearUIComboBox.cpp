...
void BearUI::Classic::BearUIComboBox::Reset()
{
	...
	UIButton.Rect +=BearVector4<float>(1, 1, -2, -2);
	...
	UITexture.Rect +=BearVector4<float>(1, 1, -2, -2);
	...
	UIText.Rect +=BearVector4<float>(1, 1, -2, -2);
...
void BearUI::Classic::BearUIComboBox::Update(BearTime time)
{
	if (m_change)
	{
		m_change = false;
